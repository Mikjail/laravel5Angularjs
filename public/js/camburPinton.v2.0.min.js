...
var app = angular.module('starter', ['ngRoute', 'camburTemplate']).constant('API_URL', './api/');
...
angular.module('starter').service('ProductsService', ProductsService).service('ProductsTypeService', ProductsTypeService);
...
function formCtrl($scope, $http, $location) {
    ...
    $scope.registrarForm = function () {
        ...
        $http.post('contactForm/pedidoForm.php', {
    ...
    $scope.registrarConsulta = function () {
        $http.post('contactForm/consultaForm.php', {
            nombreForm: $scope.nombreForm,
            apellidoForm: $scope.apellidoForm,
            mailForm: $scope.mailForm,
            telForm: $scope.telForm,
